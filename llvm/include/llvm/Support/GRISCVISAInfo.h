//===-- GRISCVISAInfo.h - RISC-V ISA Information -----------------*- C++ -*-===//
//
...
#ifndef LLVM_SUPPORT_GRISCVISAINFO_H
#define LLVM_SUPPORT_GRISCVISAINFO_H
...
class GRISCVISAInfo {
public:
  GRISCVISAInfo(const GRISCVISAInfo &) = delete;
  GRISCVISAInfo &operator=(const GRISCVISAInfo &) = delete;
  ...
  GRISCVISAInfo(unsigned XLen, OrderedExtensionMap &Exts)
  ...
  static llvm::Expected<std::unique_ptr<GRISCVISAInfo>>
  ...
  static llvm::Expected<std::unique_ptr<GRISCVISAInfo>>
  postProcessAndChecking(std::unique_ptr<GRISCVISAInfo> &&ISAInfo);
  static std::string getTargetFeatureForExtension(StringRef Ext);

private:
  GRISCVISAInfo(unsigned XLen)
