//===-- GRISCVAttributes.cpp - GRISCV Attributes ----------------------------===//
//
...
using namespace llvm::GRISCVAttrs;
...
constexpr TagNameMap GRISCVAttributeTags{TagData};
const TagNameMap &llvm::GRISCVAttrs::getGRISCVAttributeTags() {
  return GRISCVAttributeTags;
}
