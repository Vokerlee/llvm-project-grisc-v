//===-- GRISCVELFStreamer.h - GRISCV ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_GRISCV_MCTARGETDESC_GRISCVELFSTREAMER_H
#define LLVM_LIB_TARGET_GRISCV_MCTARGETDESC_GRISCVELFSTREAMER_H
...
class GRISCVTargetELFStreamer : public GRISCVTargetStreamer {
private:
...
public:
  ...
  GRISCVTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
...
#endif // LLVM_LIB_TARGET_GRISCV_MCTARGETDESC_GRISCVELFSTREAMER_H
