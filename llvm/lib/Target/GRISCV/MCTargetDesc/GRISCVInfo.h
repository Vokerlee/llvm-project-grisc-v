#ifndef __LLVM_LIB_TARGET_GRISCV_MCTARGETDESC_GRISCVINFO_H__
#define __LLVM_LIB_TARGET_GRISCV_MCTARGETDESC_GRISCVINFO_H__
...
// GRISC-V Specific Machine Operand Flags
enum {
  MO_None = 0,
  MO_CALL = 1,
  MO_PLT = 2,
...
enum OperandType : unsigned {
  ...
  OPERAND_RVKRNUM,
  OPERAND_LAST_griscv_IMM = OPERAND_RVKRNUM,
...
#endif // __LLVM_LIB_TARGET_GRISCV_MCTARGETDESC_GRISCVINFO_H__
